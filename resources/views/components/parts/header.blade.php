<header class="text-white h-20 border-b-[0.5px] border-white bg-black w-full z-50">
    <div class="max-w-7xl lg:mx-auto mx-4 flex items-center justify-between h-full">
        <!-- Nome à esquerda -->
        <div class="text-2xl font-bold font-[Great_Vibes]">
            Fernanda Fernandes
        </div>

        <!-- Menu central -->
        <nav class="hidden md:flex space-x-8 text-lg">
            <a href="#" class="hover:text-gray-300">Projetos</a>
